...
IMAT_CLASSES = ('shirt, blouse', 'top, t-shirt, sweatshirt', 'sweater', 'cardigan', 'jacket', 'vest', 'pants', 'shorts', 'skirt', 'coat', 'dress', 'jumpsuit', 'cape', 'glasses', 'hat', 'headband, head covering, hair accessory', 'tie', 'glove', 'watch', 'belt', 'leg warmer', 'tights, stockings', 'sock', 'shoe', 'bag, wallet', 'scarf', 'umbrella', 'hood', 'collar', 'lapel', 'epaulette', 'sleeve', 'pocket', 'neckline', 'buckle', 'zipper', 'applique', 'bead', 'bow', 'flower', 'fringe', 'ribbon', 'rivet', 'ruffle', 'sequin', 'tassel')

imaterialist_dataset = dataset_base.copy({

    'name': 'imaterialist',

    'train_images': '../coco_format_train',
    'train_info': '../fashion_train_dataset_10k.json',

    'valid_images': '../coco_format_test',
    'valid_info': '../fashion_test_dataset_10k.json',

    'has_gt': True,
    'class_names': IMAT_CLASSES,
})
